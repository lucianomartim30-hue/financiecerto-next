...
export const ARTIGOS: Artigo[] = [
  ...
  },
  {
    ...
    secoes: [
      {
        ...
        blocos: [
          ...
          { tipo: 'tabela',
            ...
            linhas: [
              ['MCMV', 'Renda até R$ 13.000', '4,25% a 10,00% (nominal)', 'R$ 275 mil a R$ 600 mil (por faixa)', 'Sim'],
      ...
      },
      {
        ...
        blocos: [
          ...
          { tipo: 'tabela',
            ...
            linhas: [
              ['Faixa 1', 'até R$ 3.200', '4,25% a 5,25%', 'R$ 275.000', 'até R$ 55.000'],
              ['Faixa 2', 'R$ 3.200 a R$ 5.000', '5,00% a 7,00%', 'R$ 275.000', 'até ~R$ 6.000 (só até renda de R$ 4.000)'],
              ['Faixa 3', 'R$ 5.000 a R$ 9.600', '7,66% a 8,16%', 'R$ 400.000', 'Não tem'],
              ['Faixa 4', 'R$ 9.600 a R$ 13.000', '10,00% (fixa)', 'R$ 600.000', 'Não tem'],
            ],
          },
    ...
    fatosChaveParaJoao: [
      'As 3 modalidades de financiamento: MCMV (renda até R$13.000, taxa nominal 4,25-10,00%), SBPE/SFH (qualquer renda, imóvel até R$2,25M, taxa ~11,19-11,97%), SFI (imóvel acima de R$2,25M, taxa livre ~12,5%, sem FGTS).',
      'MCMV tem 4 faixas por renda: F1 até R$3.200 (4,25-5,25%, teto R$275k, subsídio até R$55k), F2 R$3.200-5.000 (5-7% em degraus por renda, teto R$275k, subsídio só até renda R$4.000), F3 R$5.000-9.600 (7,66-8,16%, teto R$400k, sem subsídio), F4 R$9.600-13.000 (10,00% fixo, teto R$600k, sem subsídio). Fonte: tabela da Caixa abr/2026.',
