        ...
        <div style={{ marginBottom: 20, padding: '18px 18px 14px', background: '#F8FAFF', border: '1.5px solid #BFDBFE', borderRadius: 14 }}>
          ...
          {[
            ...
            },
            {
              ...
              desc: 'Assinatura do contrato + ITBI (~3% em SP, com possível isenção no MCMV) e registro em cartório (~1%). Algumas construtoras isentam o comprador desses custos — consulte a construtora.',
            },
