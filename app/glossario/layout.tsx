...
const GLOSSARY_TERMS = [
  ...
  { term: 'SBPE', answer: 'Modalidade de crédito imobiliário que usa recursos captados pela caderneta de poupança. É a linha mais comum para imóveis de médio e alto padrão (acima dos tetos do MCMV). As taxas variam entre bancos (geralmente 10–12% a.a. + TR), sem subsídio governamental. Aceita FGTS para amortização.' },
...
export default function GlossarioLayout({
  ...
  const schemas = [
    faqPage({
      url: `${SITE_CONFIG.domain}/glossario`,
      title: 'Glossário de Financiamento Imobiliário',
      description: '32 termos do financiamento imobiliário explicados de forma clara e objetiva.',
      questions: GLOSSARY_TERMS.map(term => ({
        name: term.term,
        answer: term.answer,
      })),
    }),
    breadcrumb([
      ...
      { name: 'Glossário', url: `${SITE_CONFIG.domain}/glossario` },
    ]),
  ];
