  ...
  useEffect(() => {
    ...
    import('maplibre-gl').then((mod: any) => {
      ...
      for (const pin of validPins) {
        ...
        // Sem transform no hover — scale() interfere com o posicionamento interno do MapLibre
        el.style.cssText = 'width:18px;height:18px;display:flex;align-items:center;justify-content:center;cursor:pointer;filter:drop-shadow(0 1px 4px rgba(0,0,0,.45))';
